...
export class DatabaseV121608050201304 implements MigrationInterface {
    name = 'DatabaseV121608050201304'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "software_programs" ("id" SERIAL NOT NULL, "name" character varying(191) NOT NULL, "version" character varying(20) NOT NULL, "url" character varying(255) NOT NULL, CONSTRAINT "PK_79effbd2efc8acef1c3d618f453" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "movements" ("id" SERIAL NOT NULL, "priority" smallint NOT NULL DEFAULT '0', "status" integer NOT NULL DEFAULT '0', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "accepted_at" TIMESTAMP, "notified" boolean NOT NULL DEFAULT false, "latest" boolean NOT NULL DEFAULT true, "last_id" integer, "technical_area_id" integer NOT NULL, "colaborator_id" integer, CONSTRAINT "REL_33ea97442abbaba058747f96bd" UNIQUE ("last_id"), CONSTRAINT "PK_5a8e3da15ab8f2ce353e7f58f67" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "replies" ("id" SERIAL NOT NULL, "title" character varying(100) NOT NULL, "message" text NOT NULL, "source" integer NOT NULL DEFAULT '1', "status" integer NOT NULL DEFAULT '1', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_08f619ebe431e27e9d206bea132" PRIMARY KEY ("id"))`);
